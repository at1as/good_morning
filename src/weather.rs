...
fn format_weather(json: Value) -> String {
  ...
  let text = format!("Currently {} C and {}. Today: {} with a high of {} C and low of {} C. Today's sunset is at {}.", current_temp, current_text, daily_text, daily_high, daily_low, sunset);
